...
export async function main(ns) {
    // base RAM on existing servers, or set base RAM to 2
    ...
    for (baseRAM; baseRAM <= (2 ** 20); baseRAM *= 2) {
      ...
      while (ns.getServerMoneyAvailable("home") < ns.getPurchasedServerCost(ram) * 14) {
    ...
    } ns.tprint("bought max servers ! " + baseRAM / 2)
  }
